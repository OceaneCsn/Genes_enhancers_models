...
for ct in cts[:-1]:
	...
	os.system('Rscript build_pairs_ct.R '+ct+' 00_only')

	os.system('python3 fasta_enhancers_gene_expr.py '+ct+' EG_pairs_00_only')
